...
<Heading tag="h1" class="text-center" customSize="text-2xl font-extrabold  md:text-3xl lg:text-3xl"
	>Robotics Committee
</Heading>
<Hr class="my-8" />
<p>
	The focus of robotics committee is to allow students to be creative. Dr. Molly Curnyn is in charge
	of the robotics lab. There are certain rules that ACM have plus rules that Dr. Curnyn has in
	regards to using the lab. ACM has our own Vex robotics kit that students can use along with
...
<List tag="ul" list="disc" class="ps-5 space-y-1">
	<Li
		>The students in the robotics committee will need Dr. Curnyn's permission to use the lab and when to
		use the lab.
	</Li>
	<Li
	...
	<Li>There can be multiple groups working on different robots but there would also have to be multiple project leaders.</Li>
...
<List tag="ul" list="disc" class="space-y-1 ps-5">
	...
	<Li>Diving in head first and trying to make things work is your best bet at learning robotics.</Li
	>
