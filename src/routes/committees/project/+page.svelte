...
<Hr class="my-8" />
<p>
	Project committee allows students to develop projects together in a team setting. There can be one
	or several groups within project committee whose focus is to develop something that will challenge
	and improve upon their own skills. The something can be a wide array of things involving software,
...
<List tag="ul" list="disc" class="ps-5 space-y-1">
	...
	<Li
		>To work with hardware students would have to talk to ACM Officers and the Officers will talk to
		the advisor and/or additional professors to use hardware if it isn't available.
	</Li>
	<Li
